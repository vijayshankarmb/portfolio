        ...
        <Card className="group h-full w-full overflow-hidden transition-all p-0 border-gray-100 dark:border-gray-800 shadow-none">
            ...
            <CardContent className="px-6">
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <Tooltip>
                                <TooltipTrigger>
                                    <Link
                                        className="text-neutral-500 flex size-6 items-center justify-center hover:text-primary transition-colors"
                                        href={project.link}
                                        target="_blank"
                                    >
                                        <Website />
                    ...
                    {/* Description */}
                    <p className="text-neutral-500 line-clamp-3">{project.description}</p>
